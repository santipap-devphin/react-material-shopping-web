...
import { Box  , Grid, Typography , Divider , Chip , Button} from '@mui/material';
import CardOrder from '../../component/Card/CardOrder';
import months from "../../data/dates.json";

const SecOrderAll = ({items}) => {
                                    ...
                                    <Grid item xs={12} sm={10}>
                                        ...
                                        {items.payment 
                                         ...
                                         {items.payment === false && items.notify === true
                                                ? <Chip label="แจ้งชำระ" sx={{fontSize:14}}  color="primary"/> 
                                         : null 
                                         }
                                    </Grid>
                                     <Grid item xs={12} sm={2}>
                                            {!items.payment ? 
                                                <Button variant="contained">แจ้งชำระ</Button>
                                                : null 
                                            }    
